...
cp  "${BINARIES_DIR}/zImage.exynos5422-odroidxu4" "${BINARIES_DIR}/zImage"
...
#dd iflag=dsync oflag=dsync conv=notrunc if="${UBOOT_DIR}/u-boot.bin.hardkernel"             of="${BINARIES_DIR}/sdcard.img" seek=$uboot_position
